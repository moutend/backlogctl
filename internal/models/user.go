...
var UserWhere = struct {
	...
	RoleType:       whereHelperint64{field: "\"user\".\"role_type\""},
	Language:       whereHelperstring{field: "\"user\".\"language\""},
	Email:          whereHelperstring{field: "\"user\".\"email\""},
	NulabAccountID: whereHelpernull_Int64{field: "\"user\".\"nulab_account_id\""},
	IsMyself:       whereHelperbool{field: "\"user\".\"is_myself\""},
...
var (
	userAllColumns            = []string{"id", "user_id", "name", "role_type", "language", "email", "nulab_account_id", "is_myself", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"user_id", "name", "role_type", "language", "email", "nulab_account_id", "is_myself", "created_at", "updated_at"}
